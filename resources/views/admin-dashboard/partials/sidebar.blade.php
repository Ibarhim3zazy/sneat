...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboard -->
        <li class="menu-item @yield('admin-dashboard-active') }}">
        ...
        <li class="menu-item @yield('admins-active')">
            <a href="{{ route('admin.dashboard.admins.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bxs-user-badge"></i>
                <div data-i18n="Account Settings">Admins</div>
            </a>
        </li>
        <li class="menu-item @yield('roles-active')">
            <a href="{{ route('admin.dashboard.roles.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
                <div data-i18n="Authentications">Roles</div>
            </a>
        </li>
        <li class="menu-item @yield('users-active')">
            <a href="{{ route('admin.dashboard.users.index') }}" class="menu-link">
